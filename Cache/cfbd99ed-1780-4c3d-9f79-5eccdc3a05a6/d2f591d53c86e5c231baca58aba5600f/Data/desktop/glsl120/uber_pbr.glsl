...
#endif
vec3 l9_173=((l9_170.xyz*(1.0/l9_170.w))*sc_EnvmapExposure)+vec3(1e-06);
vec3 l9_174;
if (receivesRayTracedReflections)
{
vec4 l9_175=sampleRayTracedReflections();
l9_174=mix(l9_173,l9_175.xyz,vec3(l9_175.w));
}
else
{
l9_174=l9_173;
}
l9_167=l9_174*envBRDFApprox(l9_80,abs(dot(l9_74,l9_6)));
}
#else
{
l9_167=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_177=clamp(l9_70*l9_70,0.01,1.0);
vec3 l9_178;
l9_178=sc_LightEstimationData.ambientLight*l9_78;
int l9_179=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
...
vec3 l9_181=reflect(-l9_6,l9_74);
float l9_182=dot(l9_74,l9_6);
...
l9_191=vec3(0.0);
l9_190=vec3(0.0);
l9_189=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_79,vec3(l9_66));
l9_188=1.0;
}
#else
{
...
#endif
vec3 l9_193=l9_190*l9_76;
vec3 l9_194=l9_191+l9_193;
vec3 l9_195=l9_79*l9_194;
vec3 l9_196=l9_176*l9_72;
vec3 l9_197=l9_127+l9_196;
vec3 l9_198;
if (l9_192)
{
...
vec3 l9_200=(l9_199+l9_75)+l9_189;
vec4 l9_201=vec4(l9_200,l9_188);
vec4 l9_202;
#if (!sc_BlendMode_Multiply)
{
vec3 l9_203=linearToneMapping(l9_201.xyz);
l9_202=vec4(l9_203.x,l9_203.y,l9_203.z,l9_201.w);
}
#else
{
l9_202=l9_201;
...
#endif
vec4 l9_205=ngsPixelShader(max(l9_68,vec4(0.0)));
vec4 l9_206;
if (PreviewEnabled==1)
{
vec4 l9_207;
...
{
l9_208=vec4(shaderComplexityValue*0.00392157,0.0,0.0,1.0);
}
#else
{
l9_208=vec4(0.0);
...
vec4 l9_210=max(l9_209,vec4(0.0));
sc_writeFragData0(l9_210);
vec4 l9_211=clamp(l9_210,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_212=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_212),min(1.0,l9_212+0.00392157),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_213=sc_ScreenCoordsGlobalToView(l9_5);
...
#endif
int l9_214=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_213).xy);
float l9_215=packValue(l9_214);
vec4 l9_216=vec4(0.0);
l9_216.x=l9_215;
vec4 l9_218=l9_216;
l9_218.y=packValue(l9_214);
vec4 l9_220=l9_218;
l9_220.z=packValue(l9_214);
vec4 l9_222=l9_220;
l9_222.w=packValue(l9_214);
vec4 l9_224=vec4(0.0);
l9_224.x=packValue(l9_214);
vec4 l9_226=l9_224;
l9_226.y=packValue(l9_214);
vec4 l9_228=l9_226;
l9_228.z=packValue(l9_214);
vec4 l9_229=l9_228;
l9_229.w=packValue(l9_214);
int l9_230=int(l9_211.w*255.0);
float l9_231=packValue(l9_230);
vec4 l9_232=vec4(0.0);
l9_232.x=l9_231;
vec4 l9_234=l9_232;
l9_234.y=packValue(l9_230);
vec4 l9_236=l9_234;
l9_236.z=packValue(l9_230);
vec4 l9_237=l9_236;
l9_237.w=packValue(l9_230);
sc_writeFragData0(l9_229);
sc_writeFragData1(l9_222);
sc_writeFragData2(l9_237);
...
#if (sc_OITCompositingPass)
{
vec2 l9_238=sc_ScreenCoordsGlobalToView(l9_5);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_238).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_249==0)
{
l9_252=texture2D(sc_OITAlpha0,l9_238);
l9_251=texture2D(sc_OITDepthLow0,l9_238);
l9_250=texture2D(sc_OITDepthHigh0,l9_238);
}
else
{
l9_252=l9_245;
...
if (l9_249==1)
{
l9_248=texture2D(sc_OITAlpha1,l9_238);
l9_247=texture2D(sc_OITDepthLow1,l9_238);
l9_246=texture2D(sc_OITDepthHigh1,l9_238);
}
else
{
l9_248=l9_252;
...
{
int l9_253[8]=l9_239;
unpackValues(l9_246.w,l9_249,l9_253);
unpackValues(l9_246.z,l9_249,l9_253);
unpackValues(l9_246.y,l9_249,l9_253);
unpackValues(l9_246.x,l9_249,l9_253);
unpackValues(l9_247.w,l9_249,l9_253);
unpackValues(l9_247.z,l9_249,l9_253);
unpackValues(l9_247.y,l9_249,l9_253);
unpackValues(l9_247.x,l9_249,l9_253);
int l9_262[8]=l9_240;
unpackValues(l9_248.w,l9_249,l9_262);
unpackValues(l9_248.z,l9_249,l9_262);
unpackValues(l9_248.y,l9_249,l9_262);
unpackValues(l9_248.x,l9_249,l9_262);
}
l9_245=l9_248;
l9_244=l9_247;
l9_243=l9_246;
...
vec4 l9_267=texture2D(sc_OITFilteredDepthBoundsTexture,l9_238);
...
if (l9_277)
{
vec3 l9_278=l9_271.xyz*(1.0-(float(l9_240[l9_273])*0.00392157));
