...
#endif
vec3 l9_116=((l9_113.xyz*(1.0/l9_113.w))*sc_EnvmapExposure)+vec3(1e-06);
vec3 l9_117;
if (receivesRayTracedReflections)
{
vec4 l9_118=sampleRayTracedReflections();
l9_117=mix(l9_116,l9_118.xyz,vec3(l9_118.w));
}
else
{
l9_117=l9_116;
}
l9_110=l9_117*envBRDFApprox(l9_23,abs(dot(l9_17,l9_0)));
}
#else
{
l9_110=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_120=clamp(l9_15*l9_15,0.01,1.0);
vec3 l9_121;
l9_121=sc_LightEstimationData.ambientLight*l9_21;
int l9_122=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
...
vec3 l9_124=reflect(-l9_0,l9_17);
float l9_125=dot(l9_17,l9_0);
float l9_126=(2.0/l9_123)/(4.0*max(l9_125,0.0001));
float l9_127=length((l9_124*l9_126)+(sc_LightEstimationData.sg[l9_122].axis*sc_LightEstimationData.sg[l9_122].sharpness));
float l9_128=clamp(dot(l9_17,l9_124),0.0,1.0);
float l9_129=clamp(l9_125,0.0,1.0);
float l9_130=1.0-l9_123;
l9_121+=((((((((vec3(0.31831/l9_123)*exp((l9_127-l9_126)-sc_LightEstimationData.sg[l9_122].sharpness))*sc_LightEstimationData.sg[l9_122].color)*6.28319)*(1.0-exp((-2.0)*l9_127)))/vec3(l9_127))*((1.0/(l9_128+sqrt(l9_123+((l9_130*l9_128)*l9_128))))*(1.0/(l9_129+sqrt(l9_123+((l9_130*l9_129)*l9_129))))))*(l9_21+((vec3(1.0)-l9_21)*pow(1.0-clamp(dot(l9_124,normalize(l9_124+l9_0)),0.0,1.0),5.0))))*l9_128);
l9_122++;
continue;
}
else
...
l9_134=vec3(0.0);
l9_133=vec3(0.0);
l9_132=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_22,vec3(l9_11));
l9_131=1.0;
}
#else
{
...
#endif
vec3 l9_136=l9_133*l9_19;
vec3 l9_137=l9_134+l9_136;
vec3 l9_138=l9_22*l9_137;
vec3 l9_139=l9_119*Port_SpecularAO_N006;
vec3 l9_140=l9_70+l9_139;
vec3 l9_141;
if (l9_135)
{
...
vec3 l9_143=(l9_142+l9_18)+l9_132;
vec4 l9_144=vec4(l9_143,l9_131);
vec4 l9_145;
#if (!sc_BlendMode_Multiply)
{
vec3 l9_146=linearToneMapping(l9_144.xyz);
l9_145=vec4(l9_146.x,l9_146.y,l9_146.z,l9_144.w);
}
#else
{
l9_145=l9_144;
...
#endif
vec4 l9_148=ngsPixelShader(max(l9_13,vec4(0.0)));
vec4 l9_149;
if (PreviewEnabled==1)
{
vec4 l9_150;
...
{
l9_151=vec4(shaderComplexityValue*0.00392157,0.0,0.0,1.0);
}
#else
{
l9_151=vec4(0.0);
...
#if (sc_OITDepthBoundsPass)
{
float l9_155=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_155),min(1.0,l9_155+0.00392157),0.0,0.0));
}
#endif
}
#else
...
l9_159.x=l9_158;
vec4 l9_161=l9_159;
l9_161.y=packValue(l9_157);
vec4 l9_163=l9_161;
l9_163.z=packValue(l9_157);
vec4 l9_165=l9_163;
l9_165.w=packValue(l9_157);
vec4 l9_167=vec4(0.0);
l9_167.x=packValue(l9_157);
vec4 l9_169=l9_167;
l9_169.y=packValue(l9_157);
vec4 l9_171=l9_169;
l9_171.z=packValue(l9_157);
vec4 l9_172=l9_171;
l9_172.w=packValue(l9_157);
int l9_173=int(l9_154.w*255.0);
float l9_174=packValue(l9_173);
vec4 l9_175=vec4(0.0);
l9_175.x=l9_174;
vec4 l9_177=l9_175;
l9_177.y=packValue(l9_173);
vec4 l9_179=l9_177;
l9_179.z=packValue(l9_173);
vec4 l9_180=l9_179;
l9_180.w=packValue(l9_173);
sc_writeFragData0(l9_172);
sc_writeFragData1(l9_165);
sc_writeFragData2(l9_180);
...
if (l9_192==0)
{
l9_195=texture2D(sc_OITAlpha0,l9_181);
l9_194=texture2D(sc_OITDepthLow0,l9_181);
l9_193=texture2D(sc_OITDepthHigh0,l9_181);
}
else
{
l9_195=l9_188;
...
if (l9_192==1)
{
l9_191=texture2D(sc_OITAlpha1,l9_181);
l9_190=texture2D(sc_OITDepthLow1,l9_181);
l9_189=texture2D(sc_OITDepthHigh1,l9_181);
}
else
{
l9_191=l9_195;
...
{
int l9_196[8]=l9_182;
unpackValues(l9_189.w,l9_192,l9_196);
unpackValues(l9_189.z,l9_192,l9_196);
unpackValues(l9_189.y,l9_192,l9_196);
unpackValues(l9_189.x,l9_192,l9_196);
unpackValues(l9_190.w,l9_192,l9_196);
unpackValues(l9_190.z,l9_192,l9_196);
unpackValues(l9_190.y,l9_192,l9_196);
unpackValues(l9_190.x,l9_192,l9_196);
int l9_205[8]=l9_183;
unpackValues(l9_191.w,l9_192,l9_205);
unpackValues(l9_191.z,l9_192,l9_205);
unpackValues(l9_191.y,l9_192,l9_205);
unpackValues(l9_191.x,l9_192,l9_205);
}
l9_188=l9_191;
l9_187=l9_190;
l9_186=l9_189;
...
vec4 l9_210=texture2D(sc_OITFilteredDepthBoundsTexture,l9_181);
...
if (l9_220)
{
vec3 l9_221=l9_214.xyz*(1.0-(float(l9_183[l9_216])*0.00392157));
