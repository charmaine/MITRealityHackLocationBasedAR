...
{
vec3 l9_13=sc_GetFramebufferColor().xyz;
vec3 l9_14=mix(l9_13,definedBlend(l9_13,result.xyz).xyz,vec3(result.w));
vec4 l9_15=vec4(l9_14.x,l9_14.y,l9_14.z,vec4(0.0).w);
l9_15.w=1.0;
result=l9_15;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_17=vec4(mix(vec3(1.0),l9_16.xyz,vec3(l9_16.w)),l9_16.w);
}
#else
{
vec4 l9_18;
...
#endif
l9_18=vec4(l9_16.xyz*l9_19,l9_19);
}
#else
{
l9_18=l9_16;
...
vec4 l9_1;
if (float(varColor.w>Port_Input1_N012)!=0.0)
{
l9_1=varColor;
}
else
...
vec3 l9_9=mix(vec3(0.04),l9_4*Port_Metallic_N006,l9_8);
...
#endif
l9_65=sc_SampleView(sc_EnvmapSpecularDims.xy,l9_66,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex(),13.0,sc_EnvmapSpecular);
}
#else
{
vec4 l9_67;
...
#else
{
l9_67=sc_SampleView(sc_EnvmapSpecularDims.xy,l9_64,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex(),13.0,sc_EnvmapSpecular);
}
#endif
l9_65=l9_67;
}
...
float l9_73=l9_71.y;
float l9_74=l9_71.z;
l9_70=(((((((sc_Sh[8]*0.429043)*((l9_72*l9_72)-(l9_73*l9_73)))+((sc_Sh[6]*0.743125)*(l9_74*l9_74)))+(sc_Sh[0]*0.886227))-(sc_Sh[6]*0.247708))+((((sc_Sh[4]*(l9_72*l9_73))+(sc_Sh[7]*(l9_72*l9_74)))+(sc_Sh[5]*(l9_73*l9_74)))*0.858086))+((((sc_Sh[3]*l9_72)+(sc_Sh[1]*l9_73))+(sc_Sh[2]*l9_74))*1.02333))*sc_ShIntensity;
}
#else
{
l9_70=vec3(0.0);
...
float l9_94=0.36*l9_88;
float l9_95=0.694444*l9_93;
...
l9_86=l9_85+((((sc_LightEstimationData.sg[l9_87].color/vec3(sc_LightEstimationData.sg[l9_87].sharpness))*6.28319)*((l9_92*l9_97)+(((l9_89-l9_90)*l9_91)-l9_90)))*vec3(0.31831));
l9_85=l9_86;
l9_87++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_99=clamp(pow(Port_Roughness_N006,0.666667),0.0,1.0)*5.0;
...
#endif
vec3 l9_104=((l9_101.xyz*(1.0/l9_101.w))*sc_EnvmapExposure)+vec3(1e-06);
vec3 l9_105;
if (receivesRayTracedReflections)
{
vec4 l9_106=sampleRayTracedReflections();
l9_105=mix(l9_104,l9_106.xyz,vec3(l9_106.w));
}
else
{
l9_105=l9_104;
}
l9_98=l9_105*envBRDFApprox(l9_11,abs(dot(l9_5,l9_0)));
}
#else
{
l9_98=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_108=clamp(Port_Roughness_N006*Port_Roughness_N006,0.01,1.0);
vec3 l9_109;
l9_109=sc_LightEstimationData.ambientLight*l9_9;
int l9_110=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_110<sc_LightEstimationSGCount)
{
float l9_111=l9_108*l9_108;
vec3 l9_112=reflect(-l9_0,l9_5);
float l9_113=dot(l9_5,l9_0);
float l9_114=(2.0/l9_111)/(4.0*max(l9_113,0.0001));
float l9_115=length((l9_112*l9_114)+(sc_LightEstimationData.sg[l9_110].axis*sc_LightEstimationData.sg[l9_110].sharpness));
float l9_116=clamp(dot(l9_5,l9_112),0.0,1.0);
float l9_117=clamp(l9_113,0.0,1.0);
float l9_118=1.0-l9_111;
l9_109+=((((((((vec3(0.31831/l9_111)*exp((l9_115-l9_114)-sc_LightEstimationData.sg[l9_110].sharpness))*sc_LightEstimationData.sg[l9_110].color)*6.28319)*(1.0-exp((-2.0)*l9_115)))/vec3(l9_115))*((1.0/(l9_116+sqrt(l9_111+((l9_118*l9_116)*l9_116))))*(1.0/(l9_117+sqrt(l9_111+((l9_118*l9_117)*l9_117))))))*(l9_9+((vec3(1.0)-l9_9)*pow(1.0-clamp(dot(l9_112,normalize(l9_112+l9_0)),0.0,1.0),5.0))))*l9_116);
l9_110++;
continue;
}
else
...
l9_122=vec3(0.0);
l9_121=vec3(0.0);
l9_120=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_10,vec3(Port_Opacity_N006));
l9_119=1.0;
}
#else
{
...
#endif
vec3 l9_124=l9_121*l9_7;
vec3 l9_125=l9_122+l9_124;
vec3 l9_126=l9_10*l9_125;
vec3 l9_127=l9_107*Port_SpecularAO_N006;
vec3 l9_128=l9_58+l9_127;
vec3 l9_129;
if (l9_123)
{
l9_129=l9_126*srgbToLinear(l9_119);
}
else
{
l9_129=l9_126;
}
vec3 l9_130=l9_129+l9_128;
vec3 l9_131=(l9_130+l9_6)+l9_120;
vec4 l9_132=vec4(l9_131,l9_119);
vec4 l9_133;
#if (!sc_BlendMode_Multiply)
{
vec3 l9_134=linearToneMapping(l9_132.xyz);
l9_133=vec4(l9_134.x,l9_134.y,l9_134.z,l9_132.w);
}
#else
{
l9_133=l9_132;
...
#endif
vec3 l9_135=vec3(linearToSrgb(l9_133.x),linearToSrgb(l9_133.y),linearToSrgb(l9_133.z));
l9_3=vec4(l9_135.x,l9_135.y,l9_135.z,l9_133.w);
}
#else
{
...
vec4 l9_136=ngsPixelShader(l9_1);
vec4 l9_137;
if (PreviewEnabled==1)
{
vec4 l9_138;
...
{
l9_139=vec4(shaderComplexityValue*0.00392157,0.0,0.0,1.0);
}
#else
{
l9_139=vec4(0.0);
...
vec4 l9_141=max(l9_140,vec4(0.0));
...
#if (sc_OITDepthBoundsPass)
{
float l9_143=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_143),min(1.0,l9_143+0.00392157),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_144=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
...
vec4 l9_147=vec4(0.0);
l9_147.x=l9_146;
vec4 l9_149=l9_147;
l9_149.y=packValue(l9_145);
vec4 l9_151=l9_149;
l9_151.z=packValue(l9_145);
vec4 l9_153=l9_151;
l9_153.w=packValue(l9_145);
vec4 l9_155=vec4(0.0);
l9_155.x=packValue(l9_145);
vec4 l9_157=l9_155;
l9_157.y=packValue(l9_145);
vec4 l9_159=l9_157;
l9_159.z=packValue(l9_145);
vec4 l9_160=l9_159;
l9_160.w=packValue(l9_145);
int l9_161=int(l9_142.w*255.0);
float l9_162=packValue(l9_161);
vec4 l9_163=vec4(0.0);
l9_163.x=l9_162;
vec4 l9_165=l9_163;
l9_165.y=packValue(l9_161);
vec4 l9_167=l9_165;
l9_167.z=packValue(l9_161);
vec4 l9_168=l9_167;
l9_168.w=packValue(l9_161);
sc_writeFragData0(l9_160);
sc_writeFragData1(l9_153);
sc_writeFragData2(l9_168);
...
if (l9_180==0)
{
l9_183=texture2D(sc_OITAlpha0,l9_169);
l9_182=texture2D(sc_OITDepthLow0,l9_169);
l9_181=texture2D(sc_OITDepthHigh0,l9_169);
}
else
{
l9_183=l9_176;
...
if (l9_180==1)
{
l9_179=texture2D(sc_OITAlpha1,l9_169);
l9_178=texture2D(sc_OITDepthLow1,l9_169);
l9_177=texture2D(sc_OITDepthHigh1,l9_169);
}
else
{
l9_179=l9_183;
...
{
int l9_184[8]=l9_170;
unpackValues(l9_177.w,l9_180,l9_184);
unpackValues(l9_177.z,l9_180,l9_184);
unpackValues(l9_177.y,l9_180,l9_184);
unpackValues(l9_177.x,l9_180,l9_184);
unpackValues(l9_178.w,l9_180,l9_184);
unpackValues(l9_178.z,l9_180,l9_184);
unpackValues(l9_178.y,l9_180,l9_184);
unpackValues(l9_178.x,l9_180,l9_184);
int l9_193[8]=l9_171;
unpackValues(l9_179.w,l9_180,l9_193);
unpackValues(l9_179.z,l9_180,l9_193);
unpackValues(l9_179.y,l9_180,l9_193);
unpackValues(l9_179.x,l9_180,l9_193);
}
l9_176=l9_179;
l9_175=l9_178;
l9_174=l9_177;
...
vec4 l9_198=texture2D(sc_OITFilteredDepthBoundsTexture,l9_169);
...
if (l9_208)
{
vec3 l9_209=l9_202.xyz*(1.0-(float(l9_171[l9_204])*0.00392157));
